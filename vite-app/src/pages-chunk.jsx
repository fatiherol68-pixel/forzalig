    ...
    <div className="ana-grid" style={{padding:"6px 14px"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:14}}>
        ...
        <div>
          ...
          {ilk5.map(t=>
            <div key={t.id} onClick={()=>git({sayfa:"takim",takim:t,turnuva:tk})} className="tap" style={{display:"grid",gridTemplateColumns:"20px 1fr 26px 36px 30px",gap:4,alignItems:"center",background:t.sira===1?T.gold+"14":T.bg1,borderRadius:9,padding:"8px 10px",marginBottom:4,fontSize:12,boxShadow:(gucAktif(tk)&&t.kategori)?("inset 3px 0 0 "+gucKatRenk(t.kategori,T)):undefined}}>
