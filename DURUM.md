...
- CLIENT (SIRADA): `DavetKatil` (9142) — Google giriş kapısı + kaptan formu (ad+2renk+logo) +
  oyuncu formu (ad+poz+no+foto+opsiyonel profil) + yeni RPC imzalarına bağla.
**PARÇA 3 (SIRADA) — admin oyuncu düzenleme ekranları (foto/profil ligden düzelt).**
