...
**PARÇA 3 (SIRADA) — admin oyuncu/takım düzenleme:** lig içinden oyuncu foto/profil düzelt
(oyuncuDuzenle var; foto yükleme + alan düzenleme UI eklenecek). Sonra HEPSİNİ main'e deploy.
