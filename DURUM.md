...
**TÜM PARÇALAR (1, 1.5, 2, 3) BİTTİ ve doğrulandı (feature dalında). main'e HENÜZ deploy EDİLMEDİ.**
Kalan tek şey: kullanıcı onayıyla main'e deploy + uçtan uca CANLI test (Storage/RLS/OAuth ancak
canlıda doğrulanır — harness'te değil). Kullanıcı SQL 11+12'yi çalıştırdı, DB hazır.
